defmodule BookTradingWeb do
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/bookTrading_web/templates",
        namespace: BookTradingWeb
